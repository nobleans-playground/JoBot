...
def generate_launch_description():
    simulation_dir = get_package_share_directory('jobot_simulation')
    world = LaunchConfiguration('world')
    webots_description = pathlib.Path(os.path.join(simulation_dir, 'resource', 'jobot_webots.urdf')).read_text()
